sap.ui.define([
	...
	"po/ui/model/models",
	"po/ui/Router",
	"po/ui/controller/Application"
], function(UIComponent, Device, models, Router, Application) {
	"use strict";

	return UIComponent.extend("po.ui.Component", {
		metadata: {
			"version": "0.0.1",
			"rootView": {
				viewName: "po.ui.view.App",
			...
			"config": {
				...
				serviceConfig: {
					name: "ODATA_SERVICE",
					serviceUrl: "https://46ebe007trial-dev-cap-s4-onprem-srv.cfapps.us10-001.hana.ondemand.com/odata/v4/POService/"
				}
			},
			routing: {
				config: {
					routerClass: "po.ui.Router",
